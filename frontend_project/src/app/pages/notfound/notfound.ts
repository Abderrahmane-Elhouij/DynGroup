    ...
    template: `
        ...
        <div class="px-8 min-h-screen flex justify-center items-center">
            <div class="z-10 text-center">
                <div class="text-surface-900 dark:text-surface-0 font-bold text-8xl mb-6">Oups !</div>
                <p class="leading-normal mt-0 mb-8 text-surface-700 dark:text-surface-100 text-xl font-medium">Il n'y a rien ici</p>
                <p-button [routerLink]="['/']" severity="warn" raised>Aller au tableau de bord</p-button>
            </div>
        </div>
